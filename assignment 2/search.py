...
def queryVecs(query, vocab, df_dict, doc_bm25):
    ...
    # Create dense numpy arrays initialized with zeros
...
def search(queries, vocab, df_dict, doc_bm25, d_tfidf_vecs, d_bm25_vecs, outfile_path_list):
    ...
    try:
        ...
        for query in queries:
            ...
            results_tfidf = {}
            results_bm25 = {}
            for idx, doc_id in enumerate(doc_bm25):
                results_tfidf[doc_id], results_bm25[doc_id] = compareVecs(query_tfidf_vec, query_bm25_vec, d_tfidf_vecs[idx], d_bm25_vecs[idx])
